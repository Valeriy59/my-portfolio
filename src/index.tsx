...
//
//
// const thunkCreator = () => (dispatch: any, state: any) => {
//     // сode...
// }
//
//
...
//
//     useEffect(() => {
//         dispatch(getTodosTC())              ////// dispatch thunkCreator
//     }, [])
//
...
//
//     useEffect(() => {
//         dispatch(getPostsTC())              // вызов thankCreator
//     }, [])
//
//     return (
//         <>
...
//
// const getCommentsTC = (): ThunkAction<void, RootState, unknown, ActionsType> => (dispatch) => {     ////typification
//     commentsAPI.getComments()
//         .then((res) => {
//             dispatch(getCommentsAC(res.data))
//         })
...
//
//     try {
//         const currentPost = getState().posts.find((p:PostType) => p.id === postId)     ///posts
//
//         if (currentPost) {
